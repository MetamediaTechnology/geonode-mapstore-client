...
export const EDIT_BANNER_RESOURCE = 'GEONODE:EDIT_BANNER_RESOURCE'
...
export const SET_RESOURCE_BANNER = 'GEONODE_SET_RESOURCE_BANNER'
...
export function editBannerResource(bannerUrl) {
    console.log('Action work')
    return {
        type: EDIT_BANNER_RESOURCE,
        bannerUrl
    };
}

export function setResourceBanner() {

    return {
        type: SET_RESOURCE_BANNER
    }
}
